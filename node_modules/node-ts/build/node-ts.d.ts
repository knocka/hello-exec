...
declare module 'node-ts' {
    ...
    export class TeamSpeakClient extends EventEmitter {
            ...
            send(cmd: "serverlist", params: IAssoc<any>, options: string[]): Promise<CallbackData<ServerListResponseData>>;
            ...
            send(cmd: "channellist", params: IAssoc<any>, options: string[]): Promise<CallbackData<ChannelListResponseData>>;
            ...
            send(cmd: string, params: IAssoc<Object>, options: string[]): Promise<CallbackData<QueryResponseItem>>;
            /**
